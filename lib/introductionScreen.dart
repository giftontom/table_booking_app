...
class _IntroductionScreenState extends State<IntroductionScreen> {
  ...
  void initState() {
    pageViewModelData.add(PageViewData(
      titleText: 'Choose your own hours',
      subText: 'Take-in work orders on your own hours',
      assetsImage: 'assets/images/introduction1.png',
    ));

    pageViewModelData.add(PageViewData(
      titleText: 'Cleanup',
      subText: 'Trusted janitorial service provider',
      assetsImage: 'assets/images/introduction2.png',
    ));

    pageViewModelData.add(PageViewData(
      titleText: 'Commission free delivery',
      subText: 'Choose your work order, Earn the pay',
